...
const initialEntries: TodoEntry[] = [
  ...
  'Bring your own reactivity like Preact Signals or rxjs or others',
].map((entry) => ({ val: entry, completed: true }))

const firstTodo: TodoEntry = {
  val: 'Give it a try today',
  completed: false,
}

// example-start: MinimalTodo
export const MinimalTodo = () =>
  component((): MarkLess => {
